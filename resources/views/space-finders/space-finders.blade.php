...
@section('content')
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border padding">
		...
		<br>
		This includes property for long term let or sale and also space for use and hire by the hour, day, week, month and so on.
		<br>
		...
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 padding border mb-25">
				<span class="listin-found"><b>02</b> Listings Found</span>
			</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					...
					<div class="main-box">
						...
						<div class="box-img card-image">
							<a href="spacefinder-details.php"><img src="./images/benefits/<?php echo $i ?>.jpg" alt="" width="100%" class="box-img" /></a>
						</div>
						...
						<div class="box-text1">
						<i class="fad fa-check" style="--fa-primary-color: #5f439b; --fa-secondary-color: #5f439b;"></i>&nbsp;Meeting Room +1
						</div>
