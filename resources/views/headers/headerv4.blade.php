...
<div class="header">
    ...
    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-3 border padding text-center">
        <div class="top-nav none">
            ...
            <div id="list1">
                <ul class="list1">
                    <li><a href="{{ route('home') }}"><i class="fas fa-home" style="color: #ffffff;"></i>&nbsp; Home
                            &nbsp;&nbsp;|</a></li>
                    <li><a href="{{ route('login') }}"><i class="fas fa-sign-in-alt" style="color: #ffffff;"></i>&nbsp;
                            Login &nbsp;&nbsp;|</a></li>
                    <li><a href="{{ route('register') }}"><i class="fas fa-user" style="color: #ffffff;"></i>&nbsp;
                            Join</a></li>
                </ul>
            </div>
                ...
                <div id="list2">
                    <ul>
                        <li><a href="{{ route('home') }}"><i class="fa fa-chevron-right"></i>
                                {{ trans('lang.home') }}</a></li>
                        <li><a href="{{ route('login') }}"><i class="fa fa-chevron-right"></i>
                                {{ trans('lang.login') }}</a></li>
                        <li><a href="{{ route('register') }}"><i class="fa fa-chevron-right"></i>
                                {{ trans('lang.join') }}</a></li>
                        <li><a href="{{ route('blogs.index') }}"><i class="fa fa-chevron-right"></i>
                                {{ trans('lang.news') }}</a></li>
                        <li><a href="{{ route('site-pages', 'benifits') }}"><i class="fa fa-chevron-right"></i>
                                {{ trans('lang.benifits') }}</a></li>
                        <li><a href="{{ route('directories.index') }}"><i class="fa fa-chevron-right"></i>
                                {{ trans('lang.directories') }}</a></li>
                        <li><a href="{{ route('space-finders.index') }}"><i
                                    class="fa fa-chevron-right"></i>{{ trans('lang.spacefinders') }}</a></li>
                        <li><a href="{{ route('event-calenders.index') }}"><i
                                    class="fa fa-chevron-right"></i>{{ trans('lang.eventcalenders') }}</a></li>
                        <li><a href="{{ route('platinum-partners.index') }}"><i
                                    class="fa fa-chevron-right"></i>{{ trans('lang.platiniumpartners') }}</a></li>
                        <li><a href="https://pcjh.co.uk/"><i
                                    class="fa fa-chevron-right"></i>{{ trans('lang.jobshub') }}</a></li>
                        <li><a href="{{ route('site-pages', 'about-us') }}"><i
                                    class="fa fa-chevron-right"></i>{{ trans('lang.about_us') }}</a></li>
                        <li><a href="{{ route('international') }}"><i
                                    class="fa fa-chevron-right"></i>{{ trans('lang.international') }}</a></li>
                        <li><a href="{{ route('mentoring') }}"><i
                                    class="fa fa-chevron-right"></i>{{ trans('lang.mentoring') }}</a></li>
                        <li><a href="{{ route('site-pages', 'contact-us') }}"><i
                                    class="fa fa-chevron-right"></i>{{ trans('lang.contact') }}</a></li>
                    </ul>
                    <div class="clr"></div>
                </div>

            </div>
            <img src="{{ custom_asset('icon-menu-mob.png') }}" alt="menu" title="Menu" onclick="openNav()"
                class="mbm">
        </div>
