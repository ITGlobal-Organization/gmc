<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 padding border mb-25">
				<span class="listin-found"><b>{{count($directory) }}</b> Listings Found</span>
			</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					...
					<div class="main-box">
						...
						<div class="box-img card-image">
							<a href="directory-details.php"><img src="./images/benefits/<?php echo $i ?>.jpg" alt="" width="100%" class="box-img" /></a>
						</div>
