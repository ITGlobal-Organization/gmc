            ...
            <form action="" class="store" enctype="multipart/form-data">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mtb-25">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                        ...
                        <input type="text" class="serch-input" value="" placeholder="Address"
                            name="address">
                        <div class="clr"></div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                        <label for="venue_url">Venue</label>
                        <input type="text" class="serch-input" value="" placeholder="Venue"
                            name="venue_url">
                        <div class="clr"></div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mtb-25">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20 img-div hidden" style="position:relative;">
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mtb-25 ">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20 preview-img-div hidden"
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            onChangeFile($('.img-div'), $('.upload-div'));
        });
    </script>
@endsection
