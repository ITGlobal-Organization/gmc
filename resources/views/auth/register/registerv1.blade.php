            ...
            <div class="row">
               <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 border mb-20">
                  <div>
                     ...
                     <input type="text" class="join-input" value="" placeholder="First Name *" name="first_name">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border padding mtb-25">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 border join-bg">
                        ...
                        {{-- <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 border mb-20">
                            ...
                            <input type="text" class="join-input" value="" placeholder="Twitter page" name="">
                        </div> --}}
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12 border mb-20">
                            <div>
                                ...
                                <div class="font-12 mb-20">Are you interested in receiving free mentoring for your business?
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12 border mb-20">
                            <div>
                                ...
                                <div class="font-12 mb-20">Would you like more information about the Chamber Plan from
                                    Westfield Health? (This service can be used to recover costs incurred from accessing private
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mb-20">
                            <label>Please let us know your top 3 concerns/priorities as a business joining Perthshire Chamber of
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 border mb-20">
               ...
               <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12 border mb-20">
                  <div>
                     ...
                     <div class="font-12 mb-20">Would you like more information about the Chamber Plan from
                        Westfield Health? (This service can be used to recover costs incurred from accessing private
                        healthcare including consultations, scans and dental work among many others).
                     </div>
                  </div>
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 border mb-20 padding">
                     <input type="radio" class="radio-input">
