<template>
        ...
        <div class="card card-secondary card-outline">
            <div class="card-header d-flex justify-content-end">
                <router-link class="btn btn-secondary" to="/admin/employees/create">
                    {{ Lang.add_new_msg(Lang.employee) }}
                </router-link>
  ...
  components: { Datatables,VueElementLoading },
                ...
                dropdown:[
                    {
                        ...
                        action:(row) =>{
                            ref.$router.push('/admin/employees/edit/'+row.id)
    ...
    methods:{
        ...
        async getEmployees(){
            ...
            const { records, getAll } = useEmployees();
            this.loader = true
            let ref = this
        ...
        async updateStatus(id){
            ...
            let ref = this
                confirmAlert(async () => {
                    this.loader = true
                        const { udpateStatus } = useEmployees();
