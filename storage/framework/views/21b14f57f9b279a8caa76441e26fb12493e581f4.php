...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border padding">
   <div class="middle mtb-60">
      <h1 class="text-center mb-40"><?php echo e(trans('messages.user-login-btn')); ?></h1>
      <div class="bal-btn"><a href="<?php echo e(route('register')); ?>"></i> <?php echo e(trans('messages.new-member')); ?></a> <a
         href="https://zfrmz.eu/fsRKMb3zMFky4fpj2RxE" target="_blank"></i> <?php echo e(trans('messages.existing-member')); ?></a></div>
      <!--Strat Foram Area-->
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border padding mtb-25">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 border join-bg">
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mb-20">
                  <label><?php echo e(trans('lang.email-address')); ?></label>
                  <input type="text" class="join-input email" value=""
                     placeholder="<?php echo e(trans('lang.email-address')); ?>" name="email">
               </div>
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mb-20">
                  <label><?php echo e(trans('lang.password')); ?> </label>
                  <input type="password" class="join-input password" value=""
                     placeholder="<?php echo e(trans('lang.password')); ?>" name ="password">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center pt-3">
        <a href="javascript:void(0);" class="forgot-pass"> <?php echo e(trans('lang.forget_password')); ?> </a>
      <!-- <input type="button" class="forgot-pass" value="Forgot Password"> -->
      </div>
      <!--  Forget Password POPUP-->
      <form method="POST" action="<?php echo e(route('password.email')); ?>" class="pass-reset">
        <?php echo csrf_field(); ?>
...
<script>
   ...
   $('.login').on('click', function(e) {
       e.preventDefault();
       const url = "<?php echo e(route('login.post')); ?>";
   ...
   $('.pass-reset').on('submit', function(e) {
       ...
       let url = "<?php echo e(route('password.email')); ?>";
       $.ajaxSetup({
           headers: {
               'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
           }
