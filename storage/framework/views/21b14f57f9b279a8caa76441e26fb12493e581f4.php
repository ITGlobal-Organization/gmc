...
<div class="bal-btn"><a href="<?php echo e(route('register')); ?>"></i> New Member? Join Now!</a> <a href="https://zfrmz.eu/fsRKMb3zMFky4fpj2RxE" target="_blank"></i> Existing Member? Access Now!</a></div> 
            <!--Strat Foram Area-->
            <form action="" class="login-form">
                ...
                <div class="contact-error"></div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mb-20">
                            ...
                            <input type="text" class="join-input email" value="" placeholder="<?php echo e(trans('lang.email-address')); ?>" name="email">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mb-20">
                            <label><?php echo e(trans('lang.password')); ?> </label>
                            <input type="password" class="join-input password" value="" placeholder="<?php echo e(trans('lang.password')); ?>" name ="password">
    ...
    <!-- <script>
        ...
        togglePassword.addEventListener('click', function(e) {
            ...
            if (togglePassword.src.match(
                    "<?php echo e(custom_asset('eye-open.png')); ?>")) {
                togglePassword.src =
                    "<?php echo e(custom_asset('eye-close.png')); ?>";
            } else {
                togglePassword.src =
                    "<?php echo e(custom_asset('eye-open.png')); ?>";
            }
