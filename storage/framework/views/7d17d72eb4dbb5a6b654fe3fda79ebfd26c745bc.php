                    ...
                    <div class="row">
                        ...
                        <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 pt-50" style="padding-top:50px;">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20 img-div"
                                ...
                                <img src="<?php echo e(isset($Company->media[0]->image_url) ? $Company->media[0]->image_url : asset('/media/image-not-found.png')); ?>"
                                    alt="Logo" data-id="<?php echo e(isset($Company->image->id) ? $Company->image->id : ''); ?>">
                                <div class="clr"></div>
                            </div>
                        </div>
