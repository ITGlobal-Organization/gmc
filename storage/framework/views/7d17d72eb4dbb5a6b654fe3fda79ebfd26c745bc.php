<?php $__env->startSection('content'); ?>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border padding events">
        <div class="middle mtb-60">
            <h1 class="text-center mb-25">
                <?php echo e(trans('messages.edit_msg', [
            ...
            <form action="" class="update" enctype="multipart/form-data">
                <input type="hidden" name="is_approved" id="" value="<?php echo e($Company->is_approved); ?>">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            <label for="title">Title</label>
                                <input type="text" class="serch-input" value="<?php echo e($Company->title); ?>" placeholder="Title"
                                    name="title">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            ...
                            <input type="text" class="serch-input" value="<?php echo e($Company->email); ?>" placeholder="Email"
                                name="email">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            ...
                            <input type="text" class="serch-input" value="<?php echo e($Company->phone); ?>" placeholder="Mobile No"
                                name="phone">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            ...
                            <input type="text" class="serch-input" value="<?php echo e($Company->address); ?>" placeholder="Address"
                                name="address">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            ...
                            <input type="text" class="serch-input" value="<?php echo e($Company->facebook_url); ?>"
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            ...
                            <input type="text" class="serch-input" value="<?php echo e($Company->instagram_url); ?>"
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            ...
                            <input type="text" class="serch-input" value="<?php echo e($Company->linkedin_url); ?>"
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            ...
                            <input type="text" class="serch-input" value="<?php echo e($Company->youtube_url); ?>"
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20">
                            ...
                            <input type="text" class="serch-input" value="<?php echo e($Company->website); ?>"
                        ...
                        <select class="select2-multiple form-control serch-input" name="category_ids[]" multiple="multiple"
                            ...
                            <?php $__currentLoopData = $Categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$Category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($Category->id); ?>" <?php $__currentLoopData = $Company->relatedCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($Category->id == $categories->id ? 'selected': ''); ?>   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($Category->name); ?></option>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mb-20">
                            ...
                            <textarea id="w3review" class="text-area" rows="4" name="description" rows="4"
                                value="<?php echo e($Company->description); ?>"><?php echo $Company->description; ?></textarea>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mtb-25">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20 img-div" style="position:relative;">
                                ...
                                <img src="<?php echo e(isset($Company->media[0]->image_url) ? $Company->media[0]->image_url : asset('/media/image-not-found.png')); ?>" alt="Main Image"
                                    data-id="<?php echo e(isset($Company->media[0]->id) ?  $Company->media[0]->id : ""); ?>">
                                <div class="clr"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border mtb-25">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 border mb-20 thumbnail-img-div" style="position:relative;">
                                ...
                                <img src="<?php echo e(isset($Company->media[1]->image_url) ? $Company->media[1]->image_url : asset('/media/image-not-found.png')); ?>" alt="Thumbnail"
                                    data-id="<?php echo e(isset($Company->media[1]->id) ?  $Company->media[1]->id : ""); ?>">
                                <div class="clr"></div>
                            </div>
                        </div>
    ...
    <!--End Middle-->
    <?php echo $__env->make('user.common.gallery-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $('.update').on('submit', function(e) {
        ...
        if (main_img_src != '' && thumbnail_img_src != '') {
            ...
            let url = "<?php echo e(route('user.company.update', '')); ?>" + "/" + id;
...
<?php echo $__env->make('layouts.layoutv2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/staging/resources/views/user/company/edit.blade.php ENDPATH**/ ?>