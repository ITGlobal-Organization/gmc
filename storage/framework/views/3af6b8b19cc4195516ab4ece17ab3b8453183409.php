                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="main-box">
                            <div class="box-img card-image">
                                <a href="<?php echo e($Offer->web_url != '' ?  $Offer->web_url : 'javascript::void(0)'); ?>"><img src="<?php echo e($Offer->image_url); ?>"
                                        alt="" width="100%" class="box-img" /></a>
                            </div>
                            <div class="box-name home">
                                <div style="display: flex; justify-content: center; align-items: center;">
                                    <a href="<?php echo e($Offer->web_url != '' ?  $Offer->web_url : 'javascript::void(0)'); ?>"
